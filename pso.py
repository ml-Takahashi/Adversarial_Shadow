...
from utils import (draw_shadow, image_transformation, polygon_correction,
                   random_param_generator, shadow_edge_blur)
...
class PSO:
    ...
    def fit_fun(self, position, **parameters):
        ...
        if self.physical:
            ...
            #shadow_area = np.full_like(shadow_area,255)
            #print(shadow_area)
            #exit()
            #img = self.image
